 ...
 */
@Entity
@Table(name = "wm_to_up_goods", schema = "")
@SuppressWarnings("serial")
public class WmToUpGoodsEntity implements java.io.Serializable {
	/**主键*/
...
//	@Excel(name="所属公司")
	...
	public java.lang.String getWmToUpId(){
	 ...
	 */
	public void setWmToUpId(java.lang.String wmToUpId){
