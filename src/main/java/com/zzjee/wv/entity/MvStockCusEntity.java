 ...
 */
@Entity
@Table(name = "mv_stock_cus", schema = "")
@SuppressWarnings("serial")
public class MvStockCusEntity implements java.io.Serializable {
	/**id*/
...
//	@Excel(name="单位")
	...
	@Excel(name="重量KG")
	private java.lang.Integer zhongLiang;
	/**库存单位*/
	@Excel(name="库存单位")
...
//	@Excel(name="托盘")
	 ...
	 *@return: java.lang.Integer  库存数量
	 */
	@Column(name ="ZHONG_LIANG",nullable=true,length=19)
	public java.lang.Integer getZhongLiang(){
	 ...
	 *@param: java.lang.Integer  库存数量
	 */
	public void setZhongLiang(java.lang.Integer zhongLiang){
	...
	@Column(name ="DQR",nullable=true,length=32)
	...
	@Column(name ="HITI",nullable=true,length=32)
	public java.lang.String getHiti() {
		return hiti;
	}

	public void setHiti(java.lang.String hiti) {
		this.hiti = hiti;
	}
