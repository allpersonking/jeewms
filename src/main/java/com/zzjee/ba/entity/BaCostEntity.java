 ...
 */
@Entity
@Table(name = "ba_cost", schema = "")
@SuppressWarnings("serial")
public class BaCostEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="COST_NAME",nullable=true,length=32)
	 ...
	 */
	@Column(name ="COST_TYPE_CODE",nullable=true,length=32)
