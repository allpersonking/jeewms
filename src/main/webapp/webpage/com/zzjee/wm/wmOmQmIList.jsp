...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid pageSize="500"  name="wmOmQmIList" checkbox="true" pagination="true" fitColumns="false" title="下架任务" actionUrl="wmOmQmIController.do?datagrid" idField="id" fit="true" queryMode="group">
