...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="mvStockYjController.do?doUpdate" tiptype="1" >
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${mvStockYjPage.id}' >
			
			
			<div class="tab-wrapper">
			    <!-- tab -->
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">效期预警</a></li>
			    </ul>
			    <!-- tab内容 -->
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="kuctype" name="kuctype" type="text" class="form-control"
									ignore="checked"
								  datatype="*" value='${mvStockYjPage.kuctype}' />
			          ...
			          <div class="col-xs-3">
								<input id="baseGoodscount" name="baseGoodscount" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.baseGoodscount}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="kuWeiBianMa" name="kuWeiBianMa" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.kuWeiBianMa}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="zhongWenQch" name="zhongWenQch" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.zhongWenQch}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="shpMingCheng" name="shpMingCheng" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.shpMingCheng}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="goodsProData" name="goodsProData" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.goodsProData}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="dqr" name="dqr" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.dqr}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="shangJiaCiXu" name="shangJiaCiXu" type="text" class="form-control"
									ignore="ignore"
								   value='${mvStockYjPage.shangJiaCiXu}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
...
<script src = "webpage/com/zzjee/mvyj/mvStockYj.js"></script>		
</html>